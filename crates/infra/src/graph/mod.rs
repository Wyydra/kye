...
use crate::graph::serializer::{
    deserialize_graph, load_meta, load_tombstones, save_meta, save_tombstones, serialize_event,
    serialize_graph,
};
...
impl GraphRepository for InMemoryGraphRepository {
    ...
    fn load_tombstones(
        ...
        std::collections::HashMap<domain::primitives::NodeId, chrono::DateTime<chrono::Utc>>,
        RepositoryError,
    > {
